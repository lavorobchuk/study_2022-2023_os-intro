...
![Удаление файл ~/logfile](image/6.jpg){ #fig:006 width=70% }
...
![Определение идентификаторов запущенных процессов.](image/9.jpg){ #fig:009 width=70% }
...
![Выполнение команды du.](image/12.jpg){ #fig:012 width=70% }
